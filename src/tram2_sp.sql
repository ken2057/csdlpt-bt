...
begin
	...
	begin distributed tran
		insert into ChiNhanh values (@MaCN, @TenCN, 'Ha noi', @SoDT)
		insert into QLVT_LINKED_SERVER.qlvattu.dbo.ChiNhanh values (@MaCN, @TenCN, 'Ha Noi', @SoDT)
	commit tran
end
go
-- delete
...
begin
	...
	begin distributed tran
		...
		insert into VatTu values (@MaVT, @QuiCach, @DVTinh)
	commit tran
end
-- delete
go
...
begin
	...
	begin distributed tran
		...
		insert into KhachHang values (@MAKH, @DIENTHOAI, @FAX)
	commit tran
end
go
-- delete
...
begin
	...
	begin distributed tran
		...
		insert into NHACUNGCAP values (@MANCC, @DIENTHOAI, @FAX)
	commit tran
end
go
-- delete
...
begin
	...
	from
		(select * from KhachHang) T2
		join (select * from QLVT_TRAM_1.qlvattu.dbo.KhachHang) T1
		on T1.MAKH = T2.MAKH
end
go
...
begin
	...
	from
		(select * from VATTU) T2
		join (select * from QLVT_TRAM_1.qlvattu.dbo.VATTU) T1
		on T1.MaVT = T2.MaVT
end
go
...
begin
	...
	from
		(select * from nhacungcap) T2
		join (select * from QLVT_TRAM_1.qlvattu.dbo.nhacungcap) T1
