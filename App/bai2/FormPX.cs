    ...
    public partial class formPHIEUXUAT : Form
    {
        ...
        void load_data()
        {
            try
            {
                ...
                daKhachHang = new SqlDataAdapter("sp_get_phieuxuat", conn);
        ...
        private void Button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // Viết câu lệnh SQL  
                cmd.CommandText = "sp";
                cmd.Parameters.Add(new SqlParameter("@MaPX",strMAKH));
                // Thực hiện lệnh  
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            this.txtmaKH.Text = dataGridView1.Rows[r].Cells[2].Value.ToString();
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (Them)
            {
                try
                {
                    ...
                    cmd.Parameters.Add(new SqlParameter("@mapx", txtMaPN.Text));
                    cmd.Parameters.Add(new SqlParameter("@ngayxuat", txtNgaynhap.Text));
